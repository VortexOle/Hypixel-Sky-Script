package com.vortexole.skyscript.GUIs.component.components;
...
import com.vortexole.skyscript.GUIs.component.Component;
import com.vortexole.skyscript.GUIs.MainGui;
import com.vortexole.skyscript.GUIs.component.Frame;
import com.vortexole.skyscript.GUIs.component.sub.Checkbox;
import com.vortexole.skyscript.GUIs.component.sub.Keybind;
import com.vortexole.skyscript.GUIs.component.sub.ModeButton;
import com.vortexole.skyscript.GUIs.component.sub.Slider;
...
public class Button extends Component {
    ...
    public Button(Module mod, Frame parent, int offset) {
        ...
        height = 12;
        int opY = offset + 12;
        if(NotEnoughSkids.instance.settingsManager.getSettingsByMod(mod) != null) {
            for(Setting s : NotEnoughSkids.instance.settingsManager.getSettingsByMod(mod)){
                if(s.isCombo()){
